package org.kwok.security.asymmetric_encryption;
...
public class ElGamalTest {
     ...
     *  /Library/jre/lib/security 目录下，对应覆盖local_policy.jar和US_export_policy.jar两个文件。
     *  
	 */
	public static void jdkElgamal()	{
		
		// jdk实现：“公钥加密、私钥解密” ， 对于：“私钥加密、公钥解密”有问题，因为Elgamal不支持
