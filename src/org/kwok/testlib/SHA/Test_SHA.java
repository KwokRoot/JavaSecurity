...
public class Test_SHA {
	
    public static String src = "sha test";
    ...
    public static void bcSHA224_2() throws NoSuchAlgorithmException {
        ...
        System.out.println("BC SHA224:" + org.bouncycastle.util.encoders.Hex.toHexString(bcSHA224_2));
